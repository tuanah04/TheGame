...
// các hàm điều chỉnh vị trí và kích thước của các collider (khung va chạm)
...
// hàm tạo chuyển động chạy cho nhân vật
